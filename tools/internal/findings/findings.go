...
// infoURI points consumers at the canonical proofhouse-go repository
// when they follow up on a finding. Every SARIF run records it as
// the tool driver's information URI.
const infoURI = "https://github.com/proofhouse/proofhouse-go"
...
// NewRun returns a [sarif.Run] preloaded with the proofhouse-go
